...
@app.route("/")
def home():
    # Flask is desighned that he looks into the templates folder automaticaly "templates/index.html"
...
def home_post():
    ...
    # We add "output" variable to render_template and assign to it "volume" variable
